...
#region Unity Methods
		...
		void Update()
		{
			...
			if (TweenManager.hasActiveDefaultTweens && !_isQuitting)
			{
		...
		void LateUpdate()
		{
			if (TweenManager.hasActiveLateTweens && !_isQuitting)
			{
		...
		void FixedUpdate()
		{
			if (TweenManager.hasActiveFixedTweens && Time.timeScale > 0 && !_isQuitting)
			{
