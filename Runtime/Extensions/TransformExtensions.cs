...
namespace THEBADDEST.Tweening2
{
    ...
    public static class TransformExtensions
    {
        ...
        /// <summary>
        /// Rotates the transform from start to end rotation over the specified duration (linear interpolation).
        /// </summary>
        /// <param name="target">The transform to rotate</param>
        /// <param name="start">Starting rotation in Euler angles</param>
        /// <param name="end">Ending rotation in Euler angles</param>
        ...
        /// <summary>
        /// Creates a jumping motion with specified start, peak, and end positions.
        /// </summary>
        ...
        /// <summary>
        /// Creates a shaking effect on the transform
        /// </summary>
        ...
        /// <summary>
        /// Rotates the transform to look at a point
        /// </summary>
        ...
        /// <summary>
        /// Rotates the transform to look at another transform
        /// </summary>
