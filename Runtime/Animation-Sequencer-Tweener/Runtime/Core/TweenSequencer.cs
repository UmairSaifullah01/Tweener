...
namespace THEBADDEST.Tweening2
{
    ...
    [AddComponentMenu("UI/Animation Sequencer Controller (Tweener)", 200)]
    public class TweenSequencer : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("animationSteps")]
        [SerializeReference] 
        ...
        public virtual Sequence GenerateSequence()
        {
            ...
            // Pause the sequence initially - it will be played explicitly via Play(), PlayForward(), or PlayBackwards()
